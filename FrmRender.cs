...
namespace _DCubeNoGimbalLock
{
    public partial class FrmRender : Form
    {
        ...
        {
            mainCube = new Math3D.Cube(300, 200, 75); //  Küpün boyutunu belirliyoruz.
            drawOrigin = new Point(pictureBox1.Width / 2, pictureBox1.Height / 2); // Çizimi Picturbox' un ortasýnda açýlmasýný saðlýyoruz.
        }
        ...
        private void btnReset_Click(object sender, EventArgs e)
        {
            ...
            mainCube = new Math3D.Cube(300, 200, 75);
            this.Refresh();

        }// btnReset_Click THE END
